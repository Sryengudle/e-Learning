...
class Display extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        if (nextProps !== this.props) {
            this.setState({
                url: `http://newsapi.org/v2/top-headlines?sources=${nextProps.default}&apiKey=d8a2725a8955420cbde72c01245fd36c`
            });
    ...
    getArticles(url) {
        ...
        axios.get(`http://newsapi.org/v2/top-headlines?sources=${url}&apiKey=${API}`)
            .then((response) => {
